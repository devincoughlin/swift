...
// RUN: %target-swift-frontend -module-name access_enforcement_noescape -enable-sil-ownership -enforce-exclusivity=checked -Onone -emit-sil -swift-version 3 -verify -parse-as-library %s | %FileCheck %s
// REQUIRES: asserts
